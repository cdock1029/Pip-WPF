...
public class Treasury
{
	...
	[JsonPropertyName("securityType")] public TreasurySecurityType? SecurityType { get; set; }
	...
	[JsonPropertyName("type")] public TreasuryType? Type { get; set; }
