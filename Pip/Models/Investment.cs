...
public static class InvestmentUtils
{
    ...
    {
        int thisSpan = inv.MaturityDate is null ? 0 : inv.MaturityDate.Value.DayNumber - inv.IssueDate.DayNumber;
        int otherSpan = other.MaturityDate is null ? 0 : other.MaturityDate.Value.DayNumber - other.IssueDate.DayNumber;
